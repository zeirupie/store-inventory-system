...
<body class="bg-gray-100 text-gray-500 text-[1.2em] pt-[50px]" style="background-image: url('{{ asset('bg.jpg') }}'); background-size: cover; background-position: center; background-color: rgba(0,0,0,0.5);background-blend-mode: overlay;">
    <div class="bg-red-500 text-white max-w-3xl mx-auto px-10 rounded-2xl">
    ...
    <form action="{{route('post.register')}}" method="POST">
        ...
        <div class="flex justify-center items-center h-screen">
            ...
            <div class="mb-4">
                ...
                <input type="password" id="password" name="verify_password" class="w-full p-2 border border-gray-300 rounded" >
            </div>
